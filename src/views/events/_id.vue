    ...
    >
      ...
      <div class="grid grid-cols-3 gap-x-6 mx-auto">
        <section class="col-span-2 space-y-6 w-full">
          <div
            class="w-full py-4 px-6 bg-white rounded-lg box-shadow space-y-7"
          >
            ...
            <p class="text-sm font-light w-5/6">
              Short description of the event and different techniques they used
          ...
          <div
            class="w-full py-4 px-6 bg-white rounded-lg box-shadow space-y-4"
          >
            <div class="flex justify-between items-center">
              <h4 class="flex items-center text-2xl space-x-4 font-normal">
