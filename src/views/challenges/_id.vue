      ...
      >
        <div class="space-y-4">
          ...
          <p>
            Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
            eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim
            ad minim veniam, quis nostrud exercitation ullamco laboris nisi utc
          </p>
        ...
        <section class="col-span-1 w-full space-y-5 relative">
          ...
          >
            ...
            <TypoNormalText :customClass="'!text-left leading-5'">
              ...
              commodi harum omnis illum quas, velit ab! Possimus inventore
              reiciendis repudiandae at voluptate, quos id numquam harum iste,
              ipsum illo illum.
            </TypoNormalText>
